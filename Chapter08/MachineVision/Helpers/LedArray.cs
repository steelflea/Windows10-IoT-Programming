...
namespace SenseHatIO.SenseHatLedArray
{
    ...
    public class LedArray
    {
        ...
        public static byte ColorChannelCount { get; private set; }
        ...
        public void DrawHistogram(double[] histogram, double minValue, double maxValue)
        {
        ...
        {
            int index;
            int widthStep = Length * ColorChannelCount;
